function lvmPrintPlot(model, lbls, capName, experimentNo, colour, LengthTrainSeq)
...
% MLTOOLS
  ...
  if colour
    lvmScatterPlotColor(model, lbls, LengthTrainSeq);
  else
    lvmScatterPlot(model, lbls, LengthTrainSeq);
  end
